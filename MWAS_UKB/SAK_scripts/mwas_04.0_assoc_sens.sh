...
## passed by -iin: phecode_map_sens.csv -> selected phenotypes
## passed by -iin: mwas_func.py
## passed by -iin: mwas_04.1_assoc_sens.py
## passed by -iin: mwas_04.0_assoc_sens.sh
...
python3 mwas_04.1_assoc_sens.py $batch $PHE_MAP $ICD $COV $OUT
