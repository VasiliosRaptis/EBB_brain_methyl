...
### cis-QTL: finemap with susie, https://stephenslab.github.io/susieR/articles/finemapping.html
window = 500000
L=10

# all CpGs
susie_df = tensorqtl.susie.map(
                            genotype_df, 
                            variant_df, 
                            phenotype_df, 
                            phenotype_pos_df, 
...
# save
susie_df_out_csv = outdir + "/" + prefix + ".cis_qtl_susie_all.csv"

susie_df.to_csv(susie_df_out_csv)
